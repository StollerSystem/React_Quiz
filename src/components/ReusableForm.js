    ...
    <React.Fragment>
      ...
      <Form onSubmit={props.formSubmissionHandler}>
        <Form.Group>
          ...
          <br />          
          <Form.Control name="answer2" size="sm" type="text" placeholder="Enter answer 2 here" />
          <Form.Check type="radio" aria-label="radio 1" name="correctAnswer1" value="2"/>
          <br />            
          <Form.Control name="answer3" size="sm" type="text" placeholder="Enter answer 3 here" />
